...
(function ($) {
  ...
  $("#experience-timeline").each(function () {
    ...
    $this.find(".vtimeline-point").each(function (index) {
      if (index == 0 || index == 1) {
        $(this).prepend(
          '<div class="vtimeline-icon"><img src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Walmart_Spark.svg/1925px-Walmart_Spark.svg.png" alt="Girl in a jacket"></div>'
        );
        return;
      }
      $(this).prepend(
